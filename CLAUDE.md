# Watermelon — AI Agent Instructions

Guidance for AI coding agents (Claude Code, Kilo, Cursor, etc.) working on this repository. Read this before making changes. Human collaborators: `docs/` contains the project flow and plans.
...
Full page flow and architecture: see `docs/PROJECT_FLOW.md`.
